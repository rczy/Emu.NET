...
public class InternalTests
{
    public class Immediate : Base
    {
        public Immediate() : base()
        {
            opCode = 0xAB;
            data = 0xCD;
            AddInstruction(opCode, Internals.Instructions.Internal.Execution.Immediate);
    ...
    public class ZeroPage : Base
    {
        public ZeroPage() : base()
        {
            ...
            adl = 0x04;
            data = 0xCD;
            AddInstruction(opCode, Internals.Instructions.Internal.Execution.ZeroPage);
    ...
    public class Absolute : Base
    {
        public Absolute() : base()
        {
            ...
            adh = 0x01;
            data = 0xCD;
            AddInstruction(opCode, Internals.Instructions.Internal.Execution.Absolute);
    ...
    public class IndirectX : Base
    {
        public IndirectX() : base()
        {
            ...
            adh = 0x01;
            data = 0xCD;
            AddInstruction(opCode, Internals.Instructions.Internal.Execution.IndirectX);
    ...
    public class IndirectY : Base
    {
        public IndirectY() : base()
        {
            ...
            bah = 0x01;
            data = 0xCD;
            AddInstruction(opCode, Internals.Instructions.Internal.Execution.IndirectY);
